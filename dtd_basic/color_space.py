...
if __name__ == '__main__':
    with open("label_train.txt", 'r', encoding='utf-8') as in_file:
        with open("label_train_col.txt", 'w', encoding='utf-8', newline='\n') as out_file:
            ...
            for line in lines:
                ...
                try:
                    ...
                    imageio.imsave(file_path + file_name + '_cv' + file_ext, f_cv)
                    out_file.write(file_path + file_name + '_cv' + file_ext + '\t' + line.split('\t')[1])

                    f_cc = color_space_trans(f, 1)
                    imageio.imsave(file_path + file_name + '_cc' + file_ext, f_cc)
