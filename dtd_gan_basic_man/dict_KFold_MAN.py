...
df_o = pd.read_csv("label_baseline.txt", sep="\t", header=None)
df_b = pd.read_csv("label_basic_man.txt", sep="\t", header=None)
df_g = pd.read_csv("label_gan_man.txt", sep="\t", header=None)
