...
dataloader = DataLoader(
    ImageDataset("./data/dtd/images/train", transforms_=transforms_, unaligned=True),
...
val_dataloader = DataLoader(
    ImageDataset("./data/dtd/images/test", transforms_=transforms_, unaligned=True, mode="test"),
    batch_size=5,
    shuffle=True,
    num_workers=1,
)
