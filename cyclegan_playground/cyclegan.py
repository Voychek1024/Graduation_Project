...
parser.add_argument("--dataset_name", type=str, default="banded", help="name of the dataset")
...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch, opt.n_epochs):
        for i, batch in enumerate(dataloader):
            ...
            # Print log
            run_status["loss_D"].append(loss_D.item())
            run_status["loss_G"].append(loss_G.item())
            run_status["loss_GAN"].append(loss_GAN.item())
            run_status["loss_cycle"].append(loss_cycle.item())
            run_status["loss_identity"].append(loss_identity.item())
            sys.stdout.write(
    ...
    joblib.dump(run_status, "results/cyclegan_{}_e{}-d{}_r{}_cyc{}_id{}.pkl".format(opt.dataset_name, opt.n_epochs,
                                                                                    opt.decay_epoch,
