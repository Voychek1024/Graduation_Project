...
def setup_training_loop_kwargs(
    ...
    args.data_loader_kwargs = dnnlib.EasyDict(pin_memory=False, num_workers=2, prefetch_factor=2)
    try:
    ...
    cfg_specs = {
        'low_shot':  dict(ref_gpus=-1, kimg=200,    mb=16,  mbstd=4,  fmaps=0.5,   lrate=0.0025,  gamma=1,   ema=2.5,  ramp=None, map=2, snap=10),
